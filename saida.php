<?php
   ...
   <html>
		...
		<h1 class="titulo">Declaração</h1>
			...
			<div>
				Com esse resultado,o conceito de <?php echo $nome ?> <?php echo $desempenho ?> satisfatoriamente as atividades da disciplina <?php echo $disciplina ?> do curso de <?php echo $curso ?>
				<br>
				<br>
